    ...
    <section className="flex ">
      ...
      <div className="w-full px-8 pt-6">
        ...
        <main className="flex justify-between mt-4">
          <table>
            <tr>
                <td className="font-semibold">OPCode:</td>
                <td>123456789</td>
            </tr>
            <tr>
            ...
            <tr>
                <td className="font-semibold">Re-examination Date:</td>
                <td>12/12/2023</td>
            </tr>
            <tr>
          ...
          <div>
            <table>
              ...
              <tr>
                <td className="font-semibold">Doctor Code:</td>
                <td>1234789782</td>
              </tr>
            </table>
